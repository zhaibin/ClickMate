...
class AppLocalizations {
  ...
  String get statusPaused => get('status_paused');
  ...
  String get labelDeviationThreshold => get('label_deviation_threshold');
  String get labelDeviationPx => get('label_deviation_px');
  String get labelAutoPauseResume => get('label_auto_pause_resume');
  ...
  String get msgAutoPaused => get('msg_auto_paused');
  String get msgAutoResumed => get('msg_auto_resumed');
  ...
  String get hintDeviationMin => get('hint_deviation_min');
  String get hintAutoPauseDesc => get('hint_auto_pause_desc');
  ...
  static const Map<String, String> _english = {
    ...
    'label_deviation_threshold': 'Deviation Threshold',
    'label_deviation_px': 'Deviation(px)',
    'label_auto_pause_resume': 'Auto Pause/Resume',
    ...
    'msg_auto_paused': 'Auto-paused: Mouse deviated from target',
    'msg_auto_resumed': 'Auto-resumed: Mouse returned to target',
    ...
    'hint_deviation_min': 'Deviation threshold must be ≥10px',
    'hint_auto_pause_desc': 'Auto-pause when moved away, resume after 5s stillness anywhere',
  ...
  static const Map<String, String> _simplifiedChinese = {
    ...
    'label_language': '语言',
    'label_deviation_threshold': '偏离阈值',
    'label_deviation_px': '偏离(px)',
    'label_auto_pause_resume': '自动暂停/恢复',
    'hotkey_toggle': '开始/停止',
    'hotkey_capture': '捕获',
    ...
    'msg_auto_paused': '自动暂停：鼠标偏离目标',
    'msg_auto_resumed': '自动恢复：鼠标回到目标',
    ...
    'hint_deviation_min': '偏离阈值必须≥10像素',
    'hint_auto_pause_desc': '偏离时自动暂停，任意位置静止5秒后恢复',
  ...
  static const Map<String, String> _traditionalChinese = {
    ...
    'label_language': '語言',
    'label_deviation_threshold': '偏離閾值',
    'label_deviation_px': '偏離(px)',
    'label_auto_pause_resume': '自動暫停/恢復',
    'hotkey_toggle': '開始/停止',
    'hotkey_capture': '捕獲',
    ...
    'msg_auto_paused': '自動暫停：滑鼠偏離目標',
    'msg_auto_resumed': '自動恢復：滑鼠回到目標',
    ...
    'hint_deviation_min': '偏離閾值必須≥10像素',
    'hint_auto_pause_desc': '偏離時自動暫停，任意位置靜止5秒後恢復',
  ...
  static const Map<String, String> _french = {
    ...
    'label_deviation_threshold': 'Seuil de Déviation',
    'label_deviation_px': 'Déviation(px)',
    'label_auto_pause_resume': 'Pause/Reprise Auto',
    ...
    'msg_auto_paused': 'Pause automatique: Souris déviée de la cible',
    'msg_auto_resumed': 'Reprise automatique: Souris revenue à la cible',
    ...
    'hint_deviation_min': 'Le seuil de déviation doit être ≥10px',
    'hint_auto_pause_desc': 'Pause auto si éloigné, reprend après 5s d\'immobilité n\'importe où',
  ...
  static const Map<String, String> _spanish = {
    ...
    'label_deviation_threshold': 'Limiar de Desvio',
    'label_deviation_px': 'Desvio(px)',
    'label_auto_pause_resume': 'Pausa/Retomada Auto',
    ...
    'msg_auto_paused': 'Pausa automática: Ratón desviado del objetivo',
    'msg_auto_resumed': 'Reanudación automática: Ratón volvió al objetivo',
    ...
    'hint_deviation_min': 'El umbral de desviación debe ser ≥10px',
    'hint_auto_pause_desc': 'Pausa auto al desviarse, reanuda tras 5s sin movimiento en cualquier sitio',
  ...
  static const Map<String, String> _portuguese = {
    ...
    'msg_auto_paused': 'Pausa automática: Mouse desviado do alvo',
    'msg_auto_resumed': 'Retomada automática: Mouse retornou ao alvo',
    ...
    'hint_deviation_min': 'O limiar de desvio deve ser ≥10px',
    'hint_auto_pause_desc': 'Pausa auto ao desviar, retoma após 5s parado em qualquer lugar',
  ...
  static const Map<String, String> _german = {
    ...
    'label_deviation_threshold': 'Abweichungsschwelle',
    'label_deviation_px': 'Abweichung(px)',
    'label_auto_pause_resume': 'Auto-Pause/Fortsetzen',
    ...
    'msg_auto_paused': 'Auto-pausiert: Maus vom Ziel abgewichen',
    'msg_auto_resumed': 'Auto-fortgesetzt: Maus zum Ziel zurückgekehrt',
    ...
    'hint_deviation_min': 'Abweichungsschwelle muss ≥10px sein',
    'hint_auto_pause_desc': 'Auto-Pause bei Abweichung, Fortsetzung nach 5s Stillstand überall',
  ...
  static const Map<String, String> _russian = {
    ...
    'label_language': 'Язык',
    'label_deviation_threshold': 'Порог Отклонения',
    'label_deviation_px': 'Отклонение(px)',
    'label_auto_pause_resume': 'Авто Пауза/Возобновление',
    ...
    'msg_auto_paused': 'Авто-пауза: Мышь отклонилась от цели',
    'msg_auto_resumed': 'Авто-возобновление: Мышь вернулась к цели',
    ...
    'hint_deviation_min': 'Порог отклонения должен быть ≥10px',
    'hint_auto_pause_desc': 'Авто-пауза при отклонении, возобновление через 5с покоя в любом месте',
  ...
  static const Map<String, String> _italian = {
    ...
    'label_deviation_threshold': 'Soglia di Deviazione',
    'label_deviation_px': 'Deviazione(px)',
    'label_auto_pause_resume': 'Pausa/Ripresa Auto',
    ...
    'msg_auto_paused': 'Pausa automatica: Mouse deviato dal bersaglio',
    'msg_auto_resumed': 'Ripresa automatica: Mouse tornato al bersaglio',
    ...
    'hint_deviation_min': 'La soglia di deviazione deve essere ≥10px',
    'hint_auto_pause_desc': 'Pausa auto alla deviazione, ripresa dopo 5s di immobilità ovunque',
  ...
  static const Map<String, String> _japanese = {
    ...
    'label_language': '言語',
    'label_deviation_threshold': '偏差しきい値',
    'label_deviation_px': '偏差(px)',
    'label_auto_pause_resume': '自動一時停止/再開',
    'hotkey_toggle': '開始/停止',
    ...
    'msg_auto_paused': '自動一時停止: マウスが目標から外れました',
    'msg_auto_resumed': '自動再開: マウスが目標に戻りました',
    ...
    'hint_deviation_min': '偏差しきい値は≥10ピクセル必要です',
    'hint_auto_pause_desc': '目標から離れると自動一時停止、任意の場所で5秒静止すると再開',
  ...
  static const Map<String, String> _korean = {
    ...
    'label_language': '언어',
    'label_deviation_threshold': '편차 임계값',
    'label_deviation_px': '편차(px)',
    'label_auto_pause_resume': '자동 일시중지/재개',
    'hotkey_toggle': '시작/중지',
    'hotkey_capture': '캡처',
    ...
    'msg_auto_paused': '자동 일시중지: 마우스가 목표에서 벗어남',
    'msg_auto_resumed': '자동 재개: 마우스가 목표로 돌아옴',
    ...
    'hint_deviation_min': '편차 임계값은 ≥10px여야 합니다',
    'hint_auto_pause_desc': '이탈 시 자동 일시중지, 임의 위치에서 5초 정지 시 재개',
